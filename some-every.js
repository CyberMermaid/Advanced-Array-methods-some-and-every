...
function hasAZero(num) {
    //Convert num into an Array. The Number function converts a string into a number. 
    let numArr = num.toString(10).split('').map(Number);
    return numArr.some(function (arr) {
...
function hasNoDuplicates(arr) {
    return arr.every(function (value, arr) {
...
function hasCertainKey(arr, key) {
    return arr.every(function (index, arr) {
